...
import { Board } from "../../../model/contents";
...
if (!board)
  ...
  return (
  <PageLayout title="상세 페이지" activeItem="게시판">
      ...
      <table className="w-full border-collapse border border-gray-300">
        <tbody>
          <tr className="border-b">
            ...
            <td className="px-4 py-2">게시판</td>
            <td className="bg-gray-100 px-4 py-2 font-semibold">등록일</td>
            <td className="px-4 py-2">{new Date(board.createdAt).toLocaleString()}</td>
          </tr>
          <tr className="border-b">
            <td className="bg-gray-100 px-4 py-2 font-semibold">제목</td>
            <td className="px-4 py-2" colSpan={3}>{board.title}</td>
          </tr>
          <tr className="border-b">
            <td className="bg-gray-100 px-4 py-2 font-semibold">조회</td>
            <td className="px-4 py-2" colSpan={3}>{board.views}</td>
          </tr>
          <tr className="border-b">
            <td className="bg-gray-100 px-4 py-2 font-semibold">이름</td>
            <td className="px-4 py-2" colSpan={3}>{board.writer}</td>
          </tr>
          <tr>
            <td className="bg-gray-100 px-4 py-24 font-semibold align-top">내용</td>
            <td className="px-4 py-28 min-h-[550px]" colSpan={3}>{board.content}</td>
          </tr>
        </tbody>
      </table>
