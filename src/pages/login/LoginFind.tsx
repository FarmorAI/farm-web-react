...
const LoginFind: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"findId" | "resetPwd">("findId");
  ...
  // 탭 변경 함수
  const handleTabChange = (tab: "findId" | "resetPwd") => setActiveTab(tab);
  ...
  // 아이디 찾기 요청
  const findEmail = async (e: React.FormEvent) => {
    e.preventDefault();
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-xl p-8">
        ...
        {activeTab === "findId" ? (
          <form onSubmit={findEmail} className="space-y-6">
            <div>
              <label
                htmlFor="name"
