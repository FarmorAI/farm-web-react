...
const WeatherDisplay: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-blue-100 text-gray-900 rounded-lg">
            {/* 상단 카드 */}
            <div className="flex flex-col bg-purple-200 p-6 rounded-lg transition duration-300 hover:bg-purple-300">
            ...
            <div className="grid grid-cols-4 gap-4 mt-6">
                {upcomingDays.map(([date, details]) => {
                    ...
                    return (
                        <div key={date} className="bg-pink-200 p-4 rounded-lg text-center transition duration-300 hover:bg-pink-300">
